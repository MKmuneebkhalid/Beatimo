    ...
    <div className="row">
          ...
          <ul>
            <li>
              ...
              <svg width={47} height={47} viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="45.5" y="45.5" width="44.5" height="44.5" rx="22.25" transform="rotate(-180 45.5 45.5)" stroke="#FFFAE6" strokeWidth={2} />
                <path d="M20.7219 31.8265H24.3334V24.5945H27.5874L27.9449 21.001H24.3334V19.1863C24.3334 18.9468 24.4285 18.7172 24.5978 18.5478C24.7672 18.3785 24.9968 18.2834 25.2363 18.2834H27.9449V14.6719H25.2363C24.039 14.6719 22.8907 15.1475 22.0441 15.9941C21.1975 16.8407 20.7219 17.989 20.7219 19.1863V21.001H18.9161L18.5586 24.5945H20.7219V31.8265Z" fill="#FFFAE6" />
              </svg>
            </li>
            <li>
              <div>
      ...
      <div className="col-lg-12">
        <div className="footer-logo">
          <img src="./assets/image/footer-logo.png" className="img-fluid" alt="footer-img" />
        </div>
      </div>
      <div className="col-lg-12">
        <div className="footer-bottom">
          <div>
            <p><Link className="text-light" to="" > Copyright © 2024 beatimo | Tout droits réservés </Link></p>
            <p><Link className="text-light" to="" > Préférence des témoins </Link></p>
            <p><Link className="text-light" to="/conseils-terms&condition" > Politiques et confidentialité  </Link></p>
          </div>
          <p><Link className="text-light" to=""> Site par Les Mauvais Garçons </Link></p>
        </div>
      </div>
    </div>
  </div>
