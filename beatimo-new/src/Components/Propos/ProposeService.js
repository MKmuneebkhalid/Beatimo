...
// import axiosInstance from '../Navbar/AxiosConfig'
const ProposeService = () => {
    ...
    //   e.preventDefault();
    //   try {
    //     const response = await axiosInstance.post("/enquiry-create",formData);
  ...
  return (
    <>
      <section className="nos-services-section nos-services-orange-section">
  <div className="container-fluid">
    <div className="row">
      <div className="col-lg-6">
        <div className="nos-services-left">
          <h5>
            <img src="assets/image/nos-services-icon.png" alt="Propose-Service-img" /> Notre
            expertise
          </h5>
          <h1>
            Une <span> expertise </span> approfondie en investissement
      ...
      <div className="col-lg-6">
        <div className="nos-services-right">
          <ul>
            <li onClick={()=>window.OpenService()}>
              <div>
                <span>01</span>
                <p>Ingénierie financière</p>
              </div>
              <img src="assets/image/arrow_right.png" alt="Propose-Service-img" />
            </li>
            <li onClick={()=>window.OpenService()}>
              <div>
                <span>02</span>
 ...
 <div id="mySidenav" className="sidenav">
          <Link to={{javascript:void(0)}} className="closebtn" onClick={()=>window.CloseService()}>
          ...
          <div className="sidebar-inner">
            ...
            <p>
              La planification stratégique financière est un service
              essentiel offert par notre cabinet de finance, visant à aider
              nos clients à atteindre leurs objectifs financiers à long
              terme de manière efficace et durable.
            </p>
            <p>
              En combinant une analyse approfondie des finances personnelles
              ou d'entreprise avec une vision stratégique, nous élaborons
              des stratégies sur mesure pour optimiser la gestion des
              ressources financières et maximiser les rendements.
            </p>
            ...
            <div className="sidebar-bottom">
              ...
              <p>
                Identification des opportunités d'investissement et de
                croissance pour optimiser les rendements financiers
              </p>
              <h1>Gestion des risques</h1>
              <p>
                Élaboration de stratégies de gestion des risques pour
                protéger les actifs et minimiser les pertes potentielles
              </p>
            </div>
            <div className="sidebar-bottom">
              <h5>
              ...
              <p>
                Évaluation des états financiers, des flux de trésorerie et
                des besoins en capitaux pour comprendre la situation
                actuelle
              </p>
              <h1>Élaboration de stratégies personnalisées</h1>
              <p>
                Développement de plans financiers sur mesure en fonction des
                objectifs spécifiques du client et de son appétence au
                risque
              </p>
            </div>
          </div>
        ...
        {/* <div id="formSidenav" className="sidenav">
        <Link
          to={{ javascript: void 0 }}
          className="closebtn"
          onClick={() => window.closeNavForm()}
        >
          <svg
            width={47}
            height={47}
          ...
          >
            ...
            />
            <path
              d="M19.2807 28.2057L18.2891 27.2141L22.2557 23.2474L18.2891 19.2807L19.2807 18.2891L23.2474 22.2557L27.2141 18.2891L28.2057 19.2807L24.2391 23.2474L28.2057 27.2141L27.2141 28.2057L23.2474 24.2391L19.2807 28.2057Z"
              fill="white"
            />
          </svg>
        </Link>
        <div className="sidebar-form">
          <div className="sidebar-form-heading">
            ...
            <p>
              Pour obtenir davantage d'informations, veuillez compléter le
              formulaire ci-dessous. Nous vous recontacterons dès que possible.
              Vous pouvez également nous joindre par téléphone ou par courriel.
            </p>
          </div>
