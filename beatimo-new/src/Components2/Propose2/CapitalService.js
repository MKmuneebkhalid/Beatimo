...
const CapitalService = () => {
  ...
  return (
    ...
    <>
    <section className="nos-services-section nos-services-section-2">
  <div className="container-fluid">
    <div className="row">
      <div className="col-lg-6">
        <div className="nos-services-left">
          <h5>
            <img src="assets/image/nos-services-icon.png" alt="CapitalService-img" /> Notre
            expertise
          </h5>
          <h1>
      ...
      <div className="col-lg-6">
        <div className="nos-services-right">
          <ul>
            <li onClick={() => window.openNav()}>
              <div>
                <span>01</span>
                <p>Ingénierie financière</p>
              </div>
              <img src="assets/image/arrow_right.png" alt="CapitalService-img" />
            </li>
            <li onClick={() => window.openNav()}>
              <div>
                <span>02</span>
