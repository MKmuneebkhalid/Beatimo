...
const Nav1 = ({ handleLinkClick, ServiceClick }) => {
 ...
 alert(response.data.message);    
  ...
  return (
    <>
      <section
        className={`header-section ${isHeaderVisible ? 'visible' : 'hidden'}`}
            ...
            <div className="col-lg-12">
              <nav className="navbar navbar-expand-xl ">
                <div className="top-header">
                  <Link to="/" className="beatimo-arrow">
                    <img
                      src="./assets/image/beatimo-arrow.png"
                      alt="Navbar-img"
                    />
                  </Link>
                  <Link className="navbar-brand" to="/services-conseils">
                    <img
                      src="./assets/image/beatimo-logo.png"
                      alt="Navbar-img"
                    />
                  </Link>
                  <Link className="navbar-brand-mobile" to="/services-conseils">
                    <img
                ...
                <div className="header-mobile-right">
                  <Link
                    ...
                    onClick={() => window.openNavForm()}
                    to=""
                  >
                    <img src="assets/image/call-icon.png" alt="Navbar-img" />
                  </Link>
                  <span onClick={() => window.openMobileNav()}>
                    ...
                    >
                      ...
                      <path
                        d="M16.5 30.6364V29.1364H33.5V30.6364H16.5ZM16.5 25.7518V24.2518H33.5V25.7518H16.5ZM16.5 20.8672V19.3672H33.5V20.8672H16.5Z"
                        fill="#007367"
                      />
                    </svg>
                  </span>
                ...
                >
                  <ul className="navbar-nav ms-auto ">
                    ...
                    <li className="nav-item">
                      <Link className="nav-link" to="/propos">
                        À Propos
                      </Link>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                      ...
                      >
                        <img
                          src="assets/image/call-icon.png"
                          alt="Navbar-img"
                        />
                      </Link>
                    </li>
      ...
      <div id="myMobileNav" class="sidenav">
        <div className="myMobileNav">
          <div>
            <Link to="/" className="beatimo-arrow">
              <img src="./assets/image/beatimo-arrow.png" alt="Navbar-img" />
            </Link>
            <Link className="navbar-brand-mobile" to="/">
              <img src="./assets/image/mobile-logo.png" alt="Navbar-img" />
            </Link>
          </div>
          <div>
            <Link
            ...
            >
              ...
              >
                <circle cx="25" cy="25" r="25" fill="white" />
                <path
                  d="M20.9917 29.9167L20 28.925L23.9667 24.9583L20 20.9917L20.9917 20L24.9583 23.9667L28.925 20L29.9167 20.9917L25.95 24.9583L29.9167 28.925L28.925 29.9167L24.9583 25.95L20.9917 29.9167Z"
                  fill="#007367"
                />
              </svg>
            </Link>
