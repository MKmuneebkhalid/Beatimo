      ...
      <div className="col-lg-6">
        <div className="about-content">
          <div className="about-border">
            <h1>Performante</h1>
            <img src="./assets/image/about-icon-1.png"  alt="about-section" />
        ...
        <div className="about-content about-inner">
          <div className="about-border">
            <h1>Experte</h1>
            <img src="./assets/image/about-icon-3.png"  alt="about-section" />
      ...
      <div className="col-lg-6">
        <div className="about-bottom">
          <div className="about-content">
            <div className="about-border">
              <h1>Empathique</h1>
              <img src="./assets/image/about-icon-2.png"  alt="about-section" />
